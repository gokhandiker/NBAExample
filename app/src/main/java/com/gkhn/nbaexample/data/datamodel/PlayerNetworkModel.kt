...
data class PlayerNetworkModel(
    ...
    @SerializedName("height_feet") @Expose val heightFeet: Int,
    @SerializedName("height_inches") @Expose val heightInches: Int,
    @SerializedName("last_name") @Expose val lastName: String,
    @SerializedName("position") @Expose val position: String,
    @SerializedName("team") @Expose val team: TeamNetworkModel,
    @SerializedName("weight_pounds") @Expose val weightPounds: Int
)
